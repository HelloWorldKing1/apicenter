...
> 版本：v1.1（2026-09-18）｜ 适用代码基线：M0–M5 + 前置接口编排全部已落地（自动化测试 276 个 @Test）
...
**测试基线**：全库 **276 个 @Test**（2026-09-18；含前置编排 `PreStepIntegrationTest` 15、账号登录 `AuthIntegrationTest` 14 + `PasswordHasherTest` 5、HTTP 错误语义 4、读超时 8 等）。
