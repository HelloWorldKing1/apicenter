...
| `整体测试方案.md` | **全项目测试总纲（v1.0 待评审）**：分层策略 + 自动化资产地图（174 测试全类清单）+ 手动端到端用例库（C1-C6 配置面 / F1-F6 出站 / B1-B6 入站 / 可观测 / V1-V2 版本灰度，含填值/选项/原理/查库 SQL）+ 回归矩阵与 R1-R6 验收轮次 + 清理与工具箱，执行入口见 `src/main/resources/doc/开发文档/整体测试方案.md` |
